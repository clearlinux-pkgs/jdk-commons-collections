...
License  : Apache-2.0
Requires: jdk-commons-collections-data
...
BuildRequires : six
BuildRequires : xmvn
Patch1: 0001-Port-to-Java-8.patch
...
%package data
Summary: data components for the jdk-commons-collections package.
Group: Data

%description data
data components for the jdk-commons-collections package.


%prep
%setup -q -n commons-collections-3.2.2-src
%patch1 -p1
